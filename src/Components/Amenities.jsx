...
function Amenities() {
  return (
    <div>
      <Marquee gradient gradientColor='white' gradientWidth={25} pauseOnHover autoFill className='text-BEnd'>
        <div className='bg-white rounded-lg h-28 md:h-36 lg:h-40 group w-max flex items-center justify-center relative flex-col mx-3 my-2' style={{boxShadow:"0px 0px 10px #00000038"}}>
            ...
            <div className='absolute bottom-0 bg-gradient-to-b from-[#ffffff00] to-[#ffffff] w-full py-2 h-10 group-hover:h-full transition-all duration-300 flex items-center justify-center rounded-b-lg'>
