    ...
    return (
        <div ref={homeSection} className="pt-14">
            <div className="w-full text-white font-[Montserrat]">
                ...
                <div className="relative overflow-hidden flex items-center justify-center flex-col z-[9] py-20 sm:py-14 px-5 sm:px-7 md:px-10 lg:px-16 h-[19rem] sm:h-[20rem] md:h-[25rem] lg:h-[30rem] xl:h-[35rem] bg-gradient-to-r from-[#000000d0] to-[#0000003d]">
                    <div data-aos="fade-left" className="w-[90vw] lg:w-[60rem] xl:w-[70rem] flex items-center sm:items-start justify-center flex-col">
                        ...
                        <div>
                            <a href="tel:+919133273338" className="bg-gradient-to-r from-BStart via-BMiddle to-BEnd font-semibold text-[0.7rem] sm:text-sm px-4 sm:px-5 py-2 rounded-[0.25rem]">Enquiry Now</a>
                        </div>
                    </div>
                </div>
            </div>
