...
function Services() {
    ...
    return (
        <div ref={serviceSection} className="flex items-center justify-center flex-col pt-14 font-[Montserrat]">
            <div className="h-60 md:h-80 w-full flex items-center justify-center flex-col" style={{background:`linear-gradient(to bottom,rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(${Bg})`,backgroundPosition:"center",backgroundSize:"cover"}}>
                <p data-aos="fade-up" className="text-center font-[Montserrat] text-3xl md:text-4xl font-bold text-white">Industrial Services</p>
                <div data-aos="fade-up" className="bg-white mt-1 h-0.5 w-60 sm:w-[23rem]"></div>
            </div>
